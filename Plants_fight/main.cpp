...
IMAGE img_selector_background;						// 选角界面背景图片// 墓碑图片
...
Atlas atlas_peashooter_run_left;                    // 婉逗射手朝向左的跑动动画图集
Atlas atlas_peashooter_run_right;                   // 婉逗射手朝向右的跑动动画图集
...
Atlas atlas_sunflower_run_left;                     // 向日葵朝向左的跑动动画图集
Atlas atlas_sunflower_run_right;                    // 向日葵朝向右的跑动动画图集
...
void load_game_resources() {
	...
	atlas_peashooter_idle_right.load_form_file(_T("resources/peashooter_idle_%d.png"), 9);
	flip_atlas(atlas_peashooter_idle_right, atlas_peashooter_idle_left);
	atlas_peashooter_run_right.load_form_file(_T("resources/peashooter_run_%d.png"), 5);
	flip_atlas(atlas_peashooter_run_right, atlas_peashooter_run_left);
	atlas_peashooter_attack_ex_right.load_form_file(_T("resources/peashooter_attack_ex_%d.png"), 3);
	flip_atlas(atlas_peashooter_attack_ex_right, atlas_peashooter_attack_ex_left);
	atlas_peashooter_die_right.load_form_file(_T("resources/peashooter_die_%d.png"), 4);
	flip_atlas(atlas_peashooter_die_right, atlas_peashooter_die_left);

	atlas_sunflower_idle_right.load_form_file(_T("resources/sunflower_idle_%d.png"), 8);
	flip_atlas(atlas_sunflower_idle_right, atlas_sunflower_idle_left);
	atlas_sunflower_run_right.load_form_file(_T("resources/sunflower_run_%d.png"), 5);
	flip_atlas(atlas_sunflower_run_right, atlas_sunflower_run_left);
	atlas_sunflower_attack_ex_right.load_form_file(_T("resources/sunflower_attack_ex_%d.png"), 9);
	flip_atlas(atlas_sunflower_attack_ex_right, atlas_sunflower_attack_ex_left);
	atlas_sunflower_die_right.load_form_file(_T("resources/sunflower_die_%d.png"), 2);
	flip_atlas(atlas_sunflower_die_right, atlas_sunflower_die_left);
	
	loadimage(&img_pea, _T("resources/pea.png"));
	atlas_pea_break.load_form_file(_T("resources/pea_break_%d.png"), 3);
	atlas_sun.load_form_file(_T("resources/sun_%d.png"), 5);
	atlas_sun_explode.load_form_file(_T("resources/sun_explode_%d.png"), 5);
	atlas_sun_ex.load_form_file(_T("resources/sun_ex_%d.png"), 5);
	atlas_sun_ex_explode.load_form_file(_T("resources/sun_ex_explode_%d.png"), 5);
	atlas_sun_text.load_form_file(_T("resources/sun_text_%d.png"), 6);

	atlas_run_effect.load_form_file(_T("resources/run_effect_%d.png"), 4);
	atlas_jump_effect.load_form_file(_T("resources/jump_effect_%d.png"), 5);
	atlas_land_effect.load_form_file(_T("resources/land_effect_%d.png"), 2);
	...
	mciSendString(_T("open resources/pean_break_1.mp3 alias pean_break_1"), NULL, 0, NULL);
	mciSendString(_T("open resources/pean_break_2.mp3 alias pean_break_2"), NULL, 0, NULL);
	mciSendString(_T("open resources/pean_break_3.mp3 alias pean_break_3"), NULL, 0, NULL);
	mciSendString(_T("open resources/pean_shoot_1.mp3 alias pean_shoot_1"), NULL, 0, NULL);
	mciSendString(_T("open resources/pean_shoot_2.mp3 alias pean_shoot_2"), NULL, 0, NULL);
	mciSendString(_T("open resources/pean_shoot_ex.mp3 alias pean_shoot_ex"), NULL, 0, NULL);
...
int main() {
	...
	initgraph(1280, 720, EW_SHOWCONSOLE); //初始化游戏窗口，第三个参数为显示控制台
