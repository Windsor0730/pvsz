...
extern IMAGE img_selector_background;						// 选角界面背景图片// 墓碑图片
...
private:
	...
	bool is_btn_1P_left_down = false;   //在玩家选择界面a是否摁下
	bool is_btn_1P_right_down = false;  //在玩家选择界面d是否摁下
	bool is_btn_2P_left_down = false;   //在玩家选择界面<-是否摁下
	bool is_btn_2P_right_down = false;  ////在玩家选择界面->是否摁下
