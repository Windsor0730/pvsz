...
public:
	SunBullet() {
		...
		expolde_render_offset.x = (frame_idle->getwidth() - frame_explode->getwidth()) / 2.0f;
		expolde_render_offset.y = (frame_idle->getheight() - frame_explode->getheight()) / 2.0f;
	}
